...
const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.INVALID_GENERATION_REFERENCE]:
    'Co najmniej jedna fiszka zawiera nieprawidłowe powiązanie z generacją.',
  [ERROR_CODES.GENERATION_NOT_FOUND]:
    'Nie znaleziono generacji powiązanej z co najmniej jedną fiszką.',
