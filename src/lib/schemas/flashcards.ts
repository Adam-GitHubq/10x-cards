...
const flashcardSources: readonly [FlashcardSource, ...FlashcardSource[]] = [
  'manual',
  'ai-full',
  'ai-edited',
]
...
export const PostFlashcardsBodySchema = z
  .object({
    cards: z
      ...
      .min(1, 'Należy podać co najmniej jedną fiszkę do utworzenia.'),
  })
...
export const ListFlashcardsQuerySchema = z.object({
  ...
  sort: z
    ...
    .refine(
      ...
      'Parametr sort może przyjmować wyłącznie wartość "createdAt".',
    )
    .default('createdAt'),
